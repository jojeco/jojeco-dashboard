/**
 * ConfirmDialog — wraps shadcn Dialog for destructive action confirmation.
 * Used for: server shutdown, server restart (S2), claude stop,
 * failover activate/deactivate, container stop, apply updates.
 */
import {
  Dialog,
  DialogContent,
